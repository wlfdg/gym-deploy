    ...
    <Layout>
      ...
      <div className="two-col">
        <div className="card">
          ...
          {expiring.expiring_soon.length === 0 ? <div className="empty-state">✅ No memberships expiring in 7 days</div> : (
        ...
        <div className="card">
          ...
          {expiring.expired.length === 0 ? <div className="empty-state">✅ No expired memberships</div> : (
            <div className="table-wrap"><table>
